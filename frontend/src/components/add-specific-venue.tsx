...
/**
 * Universal add box. A website URL (blog / listicle / venue) → fetch + extract
 * venues (progress shows in the live scrape panel below). A name / Maps link /
 * plain text → a skeleton lead to scrape later.
 */
