...
import { BarChart3, Building2, ClipboardList, Mail, Megaphone, Search, Settings, TrendingUp, LogOut, User, HelpCircle, Bell } from "lucide-react";
...
export function Navbar() {
  ...
  const links = [
    ...
    { href: "/log", label: "Log", icon: ClipboardList, show: true },
